...
- 若开场慢，重写前三段：直接给具体地点、具体麻烦、主角当下目标或人物反差，不要从背景说明开篇
- 若正文无趣或流水账，必须补入至少一处人物互动带来的变化：误会、嘲讽、讨价还价、规则漏洞、插队、临时交易、对手误判任选其一
...
- 若审稿指出无聊/流水账：增加“阻碍变形或策略变化”，让同一目标至少经历一次小反转，而不是连续说明流程
- 若审稿指出 AI 腔或空泛：删掉“暗流涌动/命运齿轮/一切才刚刚开始/事情并不简单”等句子，改成具体动作、物件变化、旁人反应或下一步决定
...
- 爽点要短而实，不要开挂，不要靠天降强援
- 爽点之后必须有现场反馈：旁人改口、规则松动、物件状态变化、对手退让、队伍反应、主角少付代价或得到下一步通行条件
