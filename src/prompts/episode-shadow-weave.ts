...
- 不要削弱明线的趣味点、对话张力和小爽点；织入隐线时优先强化现场反差，而不是追加解释性旁白
- 若原草稿已有好读的对话或主角小聪明，必须保留并适度打磨，不要替换成严肃玄奥的说明
...
- 新增暗示最好借“价格不对、账册涂改、旁人突然收声、令牌反应、规则临时变化、称呼异常”等低门槛细节，读者不需要知道幕后也能觉得不对劲
- 每处暗示都必须贴着主角视线或当前行动，不能打断冲突节奏单独开一段讲玄虚氛围
